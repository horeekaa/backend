...
func (r *addressProposedResolver) SubmittingAccount(ctx context.Context, obj *model.AddressProposed) (*model.Account, error) {
...
func (r *addressProposedResolver) RecentApprovingAccount(ctx context.Context, obj *model.AddressProposed) (*model.Account, error) {
	var getAccountUsecase accountpresentationusecaseinterfaces.GetAccountUsecase
	container.Make(&getAccountUsecase)
...
func (r *addressProposedResolver) RecentLog(ctx context.Context, obj *model.AddressProposed) (*model.Logging, error) {
...
// AddressProposed returns generated.AddressProposedResolver implementation.
func (r *Resolver) AddressProposed() generated.AddressProposedResolver {
	return &addressProposedResolver{r}
}

type addressProposedResolver struct{ *Resolver }
