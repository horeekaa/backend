...
func (r *purchaseOrderItemReturnResolver) Photos(ctx context.Context, obj *model.PurchaseOrderItemReturn) ([]*model.DescriptivePhoto, error) {
...
// PurchaseOrderItemReturn returns generated.PurchaseOrderItemReturnResolver implementation.
func (r *Resolver) PurchaseOrderItemReturn() generated.PurchaseOrderItemReturnResolver {
	return &purchaseOrderItemReturnResolver{r}
}

type purchaseOrderItemReturnResolver struct{ *Resolver }
