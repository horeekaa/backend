...
func (r *descriptivePhotoResolver) SubmittingAccount(ctx context.Context, obj *model.DescriptivePhoto) (*model.Account, error) {
...
func (r *descriptivePhotoResolver) RecentApprovingAccount(ctx context.Context, obj *model.DescriptivePhoto) (*model.Account, error) {
	var getAccountUsecase accountpresentationusecaseinterfaces.GetAccountUsecase
	container.Make(&getAccountUsecase)
...
func (r *descriptivePhotoResolver) RecentLog(ctx context.Context, obj *model.DescriptivePhoto) (*model.Logging, error) {
...
// DescriptivePhoto returns generated.DescriptivePhotoResolver implementation.
func (r *Resolver) DescriptivePhoto() generated.DescriptivePhotoResolver {
	return &descriptivePhotoResolver{r}
}

type descriptivePhotoResolver struct{ *Resolver }
