...
func (r *addressResolver) SubmittingAccount(ctx context.Context, obj *model.Address) (*model.Account, error) {
...
func (r *addressResolver) RecentApprovingAccount(ctx context.Context, obj *model.Address) (*model.Account, error) {
	var getAccountUsecase accountpresentationusecaseinterfaces.GetAccountUsecase
	container.Make(&getAccountUsecase)
...
func (r *addressResolver) RecentLog(ctx context.Context, obj *model.Address) (*model.Logging, error) {
