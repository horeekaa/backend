...
type TaggingDataSourceMongo interface {
	...
	Update(updateCriteria map[string]interface{}, updateData *model.DatabaseUpdateTagging, operationOptions *mongodbcoretypes.OperationOptions) (*model.Tagging, error)
